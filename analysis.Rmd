...
mf3 <- merge(dplyr::select(mf2, ID, type), df2, by="ID")
mf4 <- data.frame(mf3$ID, mf3$type, mf3$treatment, mf3$line, mf3$colony, rowSums(dplyr::select(mf3, -ID, -type, -treatment, -line, -colony)))
```
